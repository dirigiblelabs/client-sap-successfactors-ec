...
var PayScaleAreaEntityBuilder = require("sap-successfactors-ec/Foundation/Builders/PayScaleAreaEntityBuilder");
...
exports.entityBuilder = function() {
	return new PayScaleAreaEntityBuilder();
};

exports.getClient = function(configurations) {
	return new PayScaleAreaClient(configurations);
};

exports.getClientAsync = function(configurations) {
	return new PayScaleAreaClientAsync(configurations);
};

function PayScaleAreaClient (configurations) {

	var API_PATH = "/odata/v2/PayScaleArea";
...
function PayScaleAreaClientAsync (configurations) {
