...
var PayScaleTypeEntityBuilder = require("sap-successfactors-ec/Foundation/Builders/PayScaleTypeEntityBuilder");
...
exports.entityBuilder = function() {
	return new PayScaleTypeEntityBuilder();
};

exports.getClient = function(configurations) {
	return new PayScaleTypeClient(configurations);
};

exports.getClientAsync = function(configurations) {
	return new PayScaleTypeClientAsync(configurations);
};

function PayScaleTypeClient (configurations) {

	var API_PATH = "/odata/v2/PayScaleType";
...
function PayScaleTypeClientAsync (configurations) {
