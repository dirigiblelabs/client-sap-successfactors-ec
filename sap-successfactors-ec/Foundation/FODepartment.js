...
var FODepartmentEntityBuilder = require("sap-successfactors-ec/Foundation/Builders/FODepartmentEntityBuilder");

exports.COST_CENTER = "costCenter";
exports.CREATED_BY = "createdBy";
exports.CREATED_DATE_TIME = "createdDateTime";
exports.CREATED_ON = "createdOn";
exports.CUST_TO_LEGAL_ENTITY_PROP = "cust_toLegalEntityProp";
...
exports.DIVISION_FLX = "divisionFlx";
...
exports.CUST_TO_DIVISION = "cust_toDivision";
exports.CUST_TO_LEGAL_ENTITY = "cust_toLegalEntity";
exports.DESCRIPTION_TRANSLATION_NAV = "descriptionTranslationNav";
exports.DIVISION_FLX_NAV = "divisionFlxNav";
...
exports.entityBuilder = function() {
	return new FODepartmentEntityBuilder();
};

exports.getClient = function(configurations) {
	return new FODepartmentClient(configurations);
};

exports.getClientAsync = function(configurations) {
	return new FODepartmentClientAsync(configurations);
};

function FODepartmentClient (configurations) {

	var API_PATH = "/odata/v2/FODepartment";
...
function FODepartmentClientAsync (configurations) {
