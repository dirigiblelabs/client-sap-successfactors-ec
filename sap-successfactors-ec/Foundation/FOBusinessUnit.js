...
var FOBusinessUnitEntityBuilder = require("sap-successfactors-ec/Foundation/Builders/FOBusinessUnitEntityBuilder");
...
exports.entityBuilder = function() {
	return new FOBusinessUnitEntityBuilder();
};

exports.getClient = function(configurations) {
	return new FOBusinessUnitClient(configurations);
};

exports.getClientAsync = function(configurations) {
	return new FOBusinessUnitClientAsync(configurations);
};

function FOBusinessUnitClient (configurations) {

	var API_PATH = "/odata/v2/FOBusinessUnit";
...
function FOBusinessUnitClientAsync (configurations) {
