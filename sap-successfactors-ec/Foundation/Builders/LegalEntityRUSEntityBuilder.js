var method = LegalEntityRUSEntityBuilder.prototype;

function LegalEntityRUSEntityBuilder() {
...
method.okpoNumber = function(okpoNumber) {
	this.okpoNumber = okpoNumber;
	return this;
};
...
method.build = function() {
	return {
		...
		okpoNumber: this.okpoNumber
	};
};

module.exports = LegalEntityRUSEntityBuilder;
