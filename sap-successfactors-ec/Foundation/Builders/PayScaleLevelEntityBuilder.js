var method = PayScaleLevelEntityBuilder.prototype;

function PayScaleLevelEntityBuilder() {
...
method.nextPayScaleLevel = function(nextPayScaleLevel) {
	this.nextPayScaleLevel = nextPayScaleLevel;
	return this;
};

method.payScaleLevel = function(payScaleLevel) {
	this.payScaleLevel = payScaleLevel;
	return this;
};

method.nextPayScaleLevelNav = function(nextPayScaleLevelNav) {
	this.nextPayScaleLevelNav = nextPayScaleLevelNav;
	return this;
};
...
method.toPayScalePayComponents = function(toPayScalePayComponents) {
	this.toPayScalePayComponents = toPayScalePayComponents;
	return this;
};
...
method.build = function() {
	return {
		...
		nextPayScaleLevel: this.nextPayScaleLevel,
		payScaleLevel: this.payScaleLevel,
		nextPayScaleLevelNav: this.nextPayScaleLevelNav,
		payScaleGroup: this.payScaleGroup,
		toPayScalePayComponents: this.toPayScalePayComponents
	};
};

module.exports = PayScaleLevelEntityBuilder;
