var method = FOCompanyEntityBuilder.prototype;

function FOCompanyEntityBuilder() {
...
method.defaultLocation = function(defaultLocation) {
	this.defaultLocation = defaultLocation;
	return this;
};

method.defaultPayGroup = function(defaultPayGroup) {
	this.defaultPayGroup = defaultPayGroup;
	return this;
};
...
method.defaultLocationNav = function(defaultLocationNav) {
	this.defaultLocationNav = defaultLocationNav;
	return this;
};

method.defaultPayGroupNav = function(defaultPayGroupNav) {
	this.defaultPayGroupNav = defaultPayGroupNav;
	return this;
};
...
method.localNavARG = function(localNavARG) {
	this.localNavARG = localNavARG;
	return this;
};

method.localNavDEFLT = function(localNavDEFLT) {
	this.localNavDEFLT = localNavDEFLT;
	return this;
};

method.localNavDEU = function(localNavDEU) {
	this.localNavDEU = localNavDEU;
	return this;
};

method.localNavESP = function(localNavESP) {
	this.localNavESP = localNavESP;
	return this;
};

method.localNavFRA = function(localNavFRA) {
	this.localNavFRA = localNavFRA;
	return this;
};

method.localNavUSA = function(localNavUSA) {
	this.localNavUSA = localNavUSA;
	return this;
};
...
method.toLegalEntityARG = function(toLegalEntityARG) {
	this.toLegalEntityARG = toLegalEntityARG;
	return this;
};

method.toLegalEntityDEU = function(toLegalEntityDEU) {
	this.toLegalEntityDEU = toLegalEntityDEU;
	return this;
};

method.toLegalEntityESP = function(toLegalEntityESP) {
	this.toLegalEntityESP = toLegalEntityESP;
	return this;
};

method.toLegalEntityFRA = function(toLegalEntityFRA) {
	this.toLegalEntityFRA = toLegalEntityFRA;
	return this;
};

method.toLegalEntityRUS = function(toLegalEntityRUS) {
	this.toLegalEntityRUS = toLegalEntityRUS;
	return this;
};

method.toLegalEntityUSA = function(toLegalEntityUSA) {
	this.toLegalEntityUSA = toLegalEntityUSA;
	return this;
};
...
method.build = function() {
	return {
		...
		defaultPayGroup: this.defaultPayGroup,
		...
		defaultLocationNav: this.defaultLocationNav,
		defaultPayGroupNav: this.defaultPayGroupNav,
		descriptionTranslationNav: this.descriptionTranslationNav,
		localNavARG: this.localNavARG,
		localNavDEFLT: this.localNavDEFLT,
		localNavDEU: this.localNavDEU,
		localNavESP: this.localNavESP,
		localNavFRA: this.localNavFRA,
		localNavUSA: this.localNavUSA,
		nameTranslationNav: this.nameTranslationNav,
		toLegalEntityARG: this.toLegalEntityARG,
		toLegalEntityDEU: this.toLegalEntityDEU,
		toLegalEntityESP: this.toLegalEntityESP,
		toLegalEntityFRA: this.toLegalEntityFRA,
		toLegalEntityRUS: this.toLegalEntityRUS,
		toLegalEntityUSA: this.toLegalEntityUSA
	};
};

module.exports = FOCompanyEntityBuilder;
