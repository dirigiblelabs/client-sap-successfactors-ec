var method = FOJobFunctionEntityBuilder.prototype;

function FOJobFunctionEntityBuilder() {
...
method.jobFunctionType = function(jobFunctionType) {
...
method.parentFunctionCode = function(parentFunctionCode) {
...
method.parentFunctionCodeNav = function(parentFunctionCodeNav) {
	this.parentFunctionCodeNav = parentFunctionCodeNav;
	return this;
};
...
method.build = function() {
	return {
		...
		jobFunctionType: this.jobFunctionType,
		...
		parentFunctionCode: this.parentFunctionCode,
		startDate: this.startDate,
		status: this.status,
		type: this.type,
		descriptionTranslationNav: this.descriptionTranslationNav,
		nameTranslationNav: this.nameTranslationNav,
		parentFunctionCodeNav: this.parentFunctionCodeNav
	};
};

module.exports = FOJobFunctionEntityBuilder;
