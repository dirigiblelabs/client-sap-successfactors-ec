var method = PayCalendarEntityBuilder.prototype;

function PayCalendarEntityBuilder() {
...
method.toPayPeriod = function(toPayPeriod) {
	this.toPayPeriod = toPayPeriod;
	return this;
};
...
method.build = function() {
	return {
		...
		toPayPeriod: this.toPayPeriod
	};
};

module.exports = PayCalendarEntityBuilder;
