var method = FODepartmentEntityBuilder.prototype;

function FODepartmentEntityBuilder() {
...
method.cust_toLegalEntityProp = function(cust_toLegalEntityProp) {
	this.cust_toLegalEntityProp = cust_toLegalEntityProp;
	return this;
};
...
method.divisionFlx = function(divisionFlx) {
	this.divisionFlx = divisionFlx;
	return this;
};
...
method.headOfUnit = function(headOfUnit) {
...
method.cust_toDivision = function(cust_toDivision) {
	this.cust_toDivision = cust_toDivision;
	return this;
};

method.cust_toLegalEntity = function(cust_toLegalEntity) {
	this.cust_toLegalEntity = cust_toLegalEntity;
	return this;
};
...
method.divisionFlxNav = function(divisionFlxNav) {
	this.divisionFlxNav = divisionFlxNav;
	return this;
};
...
method.parentNav = function(parentNav) {
...
method.build = function() {
	return {
		...
		cust_toLegalEntityProp: this.cust_toLegalEntityProp,
		...
		divisionFlx: this.divisionFlx,
		endDate: this.endDate,
		externalCode: this.externalCode,
		headOfUnit: this.headOfUnit,
		...
		cust_toDivision: this.cust_toDivision,
		cust_toLegalEntity: this.cust_toLegalEntity,
		descriptionTranslationNav: this.descriptionTranslationNav,
		divisionFlxNav: this.divisionFlxNav,
		nameTranslationNav: this.nameTranslationNav,
		parentNav: this.parentNav
	};
};

module.exports = FODepartmentEntityBuilder;
