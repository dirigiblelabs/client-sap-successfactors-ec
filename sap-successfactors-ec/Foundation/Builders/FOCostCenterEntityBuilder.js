var method = FOCostCenterEntityBuilder.prototype;

function FOCostCenterEntityBuilder() {

}

method.costcenterExternalObjectID = function(costcenterExternalObjectID) {
	this.costcenterExternalObjectID = costcenterExternalObjectID;
	return this;
};

method.costcenterManager = function(costcenterManager) {
...
method.cust_LegalEntityProp = function(cust_LegalEntityProp) {
	this.cust_LegalEntityProp = cust_LegalEntityProp;
	return this;
};
...
method.glStatementCode = function(glStatementCode) {
	this.glStatementCode = glStatementCode;
	return this;
};
...
method.cust_LegalEntity = function(cust_LegalEntity) {
	this.cust_LegalEntity = cust_LegalEntity;
	return this;
};
...
method.build = function() {
	return {
		costcenterExternalObjectID: this.costcenterExternalObjectID,
		costcenterManager: this.costcenterManager,
		createdBy: this.createdBy,
		createdDateTime: this.createdDateTime,
		createdOn: this.createdOn,
		cust_LegalEntityProp: this.cust_LegalEntityProp,
		...
		glStatementCode: this.glStatementCode,
		...
		status: this.status,
		cust_LegalEntity: this.cust_LegalEntity,
...
module.exports = FOCostCenterEntityBuilder;
