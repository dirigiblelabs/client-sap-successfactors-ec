var method = LegalEntityARGEntityBuilder.prototype;

function LegalEntityARGEntityBuilder() {
...
method.cuit = function(cuit) {
	this.cuit = cuit;
	return this;
};

method.cuitCode = function(cuitCode) {
	this.cuitCode = cuitCode;
	return this;
};
...
module.exports = LegalEntityARGEntityBuilder;
