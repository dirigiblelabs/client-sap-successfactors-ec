var method = ReplicationTargetSystemEntityBuilder.prototype;

function ReplicationTargetSystemEntityBuilder() {
...
method.isOrganizationalManagementIntegration = function(isOrganizationalManagementIntegration) {
	this.isOrganizationalManagementIntegration = isOrganizationalManagementIntegration;
	return this;
};

method.isPayrollIntegration = function(isPayrollIntegration) {
	this.isPayrollIntegration = isPayrollIntegration;
	return this;
};
...
method.replicationTimeOffsetInMinutes = function(replicationTimeOffsetInMinutes) {
	this.replicationTimeOffsetInMinutes = replicationTimeOffsetInMinutes;
	return this;
};

method.sapSystemConfiguration = function(sapSystemConfiguration) {
	this.sapSystemConfiguration = sapSystemConfiguration;
	return this;
};
...
method.build = function() {
	return {
		...
		isOrganizationalManagementIntegration: this.isOrganizationalManagementIntegration,
		isPayrollIntegration: this.isPayrollIntegration,
		...
		replicationTimeOffsetInMinutes: this.replicationTimeOffsetInMinutes,
		sapSystemConfiguration: this.sapSystemConfiguration
	};
};

module.exports = ReplicationTargetSystemEntityBuilder;
