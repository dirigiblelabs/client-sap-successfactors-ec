var method = EmployeeDataReplicationNotificationEntityBuilder.prototype;

function EmployeeDataReplicationNotificationEntityBuilder() {
...
method.replicationEvent = function(replicationEvent) {
	this.replicationEvent = replicationEvent;
	return this;
};

method.replicationEventTime = function(replicationEventTime) {
	this.replicationEventTime = replicationEventTime;
	return this;
};
...
method.senderId = function(senderId) {
...
method.build = function() {
	return {
		...
		replicationEvent: this.replicationEvent,
		replicationEventTime: this.replicationEventTime,
...
module.exports = EmployeeDataReplicationNotificationEntityBuilder;
