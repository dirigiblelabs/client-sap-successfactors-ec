var method = EmployeeDataReplicationConfirmationEntityBuilder.prototype;

function EmployeeDataReplicationConfirmationEntityBuilder() {

}

method.additionalTimeInformation = function(additionalTimeInformation) {
	this.additionalTimeInformation = additionalTimeInformation;
	return this;
};
...
method.proxyExternalCodeList = function(proxyExternalCodeList) {
	this.proxyExternalCodeList = proxyExternalCodeList;
	return this;
};
...
method.replicationStartTime = function(replicationStartTime) {
...
method.employeeDataReplicationConfirmationErrorMessages = function(employeeDataReplicationConfirmationErrorMessages) {
	this.employeeDataReplicationConfirmationErrorMessages = employeeDataReplicationConfirmationErrorMessages;
	return this;
};
...
method.build = function() {
	return {
		additionalTimeInformation: this.additionalTimeInformation,
		...
		proxyExternalCodeList: this.proxyExternalCodeList,
		...
		employeeDataReplicationConfirmationErrorMessages: this.employeeDataReplicationConfirmationErrorMessages,
		replicationTargetSystemNav: this.replicationTargetSystemNav
	};
};

module.exports = EmployeeDataReplicationConfirmationEntityBuilder;
