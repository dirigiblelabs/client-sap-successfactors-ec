var method = BenefitContactEntityBuilder.prototype;

function BenefitContactEntityBuilder() {

}

method.contactEmail = function(contactEmail) {
	this.contactEmail = contactEmail;
	return this;
};

method.contactEmployeeId = function(contactEmployeeId) {
	this.contactEmployeeId = contactEmployeeId;
	return this;
};

method.contactPhone = function(contactPhone) {
	this.contactPhone = contactPhone;
	return this;
};

method.contactType = function(contactType) {
...
method.employeeName = function(employeeName) {
...
module.exports = BenefitContactEntityBuilder;
