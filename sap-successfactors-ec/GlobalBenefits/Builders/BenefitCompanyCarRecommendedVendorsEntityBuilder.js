var method = BenefitCompanyCarRecommendedVendorsEntityBuilder.prototype;

function BenefitCompanyCarRecommendedVendorsEntityBuilder() {

}

method.carVendorName = function(carVendorName) {
	this.carVendorName = carVendorName;
	return this;
};
...
method.build = function() {
	return {
		carVendorName: this.carVendorName,
...
module.exports = BenefitCompanyCarRecommendedVendorsEntityBuilder;
