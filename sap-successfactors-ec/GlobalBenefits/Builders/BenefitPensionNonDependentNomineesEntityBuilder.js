var method = BenefitPensionNonDependentNomineesEntityBuilder.prototype;

function BenefitPensionNonDependentNomineesEntityBuilder() {
...
method.contact = function(contact) {
...
method.nomineesId = function(nomineesId) {
	this.nomineesId = nomineesId;
	return this;
};
...
method.build = function() {
	return {
		...
		name: this.name,
		nomineesId: this.nomineesId,
		percentage: this.percentage
	};
};

module.exports = BenefitPensionNonDependentNomineesEntityBuilder;
