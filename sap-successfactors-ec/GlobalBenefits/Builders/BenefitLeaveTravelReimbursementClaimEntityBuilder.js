var method = BenefitLeaveTravelReimbursementClaimEntityBuilder.prototype;

function BenefitLeaveTravelReimbursementClaimEntityBuilder() {
...
method.modeOfTravel = function(modeOfTravel) {
	this.modeOfTravel = modeOfTravel;
	return this;
};

method.placeOfTravel = function(placeOfTravel) {
	this.placeOfTravel = placeOfTravel;
	return this;
};

method.travelEndDate = function(travelEndDate) {
	this.travelEndDate = travelEndDate;
	return this;
};

method.travelStartDate = function(travelStartDate) {
...
module.exports = BenefitLeaveTravelReimbursementClaimEntityBuilder;
