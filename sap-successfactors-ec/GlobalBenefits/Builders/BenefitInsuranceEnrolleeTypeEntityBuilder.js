var method = BenefitInsuranceEnrolleeTypeEntityBuilder.prototype;

function BenefitInsuranceEnrolleeTypeEntityBuilder() {
...
method.maxDependents = function(maxDependents) {
...
method.minDependents = function(minDependents) {
...
method.build = function() {
	return {
		...
		minDependents: this.minDependents,
		relationShipType: this.relationShipType
	};
};

module.exports = BenefitInsuranceEnrolleeTypeEntityBuilder;
