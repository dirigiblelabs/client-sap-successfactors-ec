...
var PerGlobalInfoCHNEntityBuilder = require("sap-successfactors-ec/EmployeeGlobalInformation/Builders/PerGlobalInfoCHNEntityBuilder");
...
exports.entityBuilder = function() {
	return new PerGlobalInfoCHNEntityBuilder();
};

exports.getClient = function(configurations) {
	return new PerGlobalInfoCHNClient(configurations);
};

exports.getClientAsync = function(configurations) {
	return new PerGlobalInfoCHNClientAsync(configurations);
};

function PerGlobalInfoCHNClient (configurations) {

	var API_PATH = "/odata/v2/PerGlobalInfoCHN";
...
function PerGlobalInfoCHNClientAsync (configurations) {
