...
var PerGlobalInfoDEUEntityBuilder = require("sap-successfactors-ec/EmployeeGlobalInformation/Builders/PerGlobalInfoDEUEntityBuilder");
...
exports.entityBuilder = function() {
	return new PerGlobalInfoDEUEntityBuilder();
};

exports.getClient = function(configurations) {
	return new PerGlobalInfoDEUClient(configurations);
};

exports.getClientAsync = function(configurations) {
	return new PerGlobalInfoDEUClientAsync(configurations);
};

function PerGlobalInfoDEUClient (configurations) {

	var API_PATH = "/odata/v2/PerGlobalInfoDEU";
...
function PerGlobalInfoDEUClientAsync (configurations) {
