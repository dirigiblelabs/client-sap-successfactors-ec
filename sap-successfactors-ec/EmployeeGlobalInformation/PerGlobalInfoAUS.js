...
var PerGlobalInfoAUSEntityBuilder = require("sap-successfactors-ec/EmployeeGlobalInformation/Builders/PerGlobalInfoAUSEntityBuilder");
...
exports.entityBuilder = function() {
	return new PerGlobalInfoAUSEntityBuilder();
};

exports.getClient = function(configurations) {
	return new PerGlobalInfoAUSClient(configurations);
};

exports.getClientAsync = function(configurations) {
	return new PerGlobalInfoAUSClientAsync(configurations);
};

function PerGlobalInfoAUSClient (configurations) {

	var API_PATH = "/odata/v2/PerGlobalInfoAUS";
...
function PerGlobalInfoAUSClientAsync (configurations) {
