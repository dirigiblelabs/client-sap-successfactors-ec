var method = ApprenticeSchoolEventEntityBuilder.prototype;

function ApprenticeSchoolEventEntityBuilder() {
...
method.schoolNav = function(schoolNav) {
	this.schoolNav = schoolNav;
	return this;
};
...
method.build = function() {
	return {
		...
		schoolNav: this.schoolNav
	};
};

module.exports = ApprenticeSchoolEventEntityBuilder;
