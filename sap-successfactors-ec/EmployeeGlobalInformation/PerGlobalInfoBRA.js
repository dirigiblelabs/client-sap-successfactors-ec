...
var PerGlobalInfoBRAEntityBuilder = require("sap-successfactors-ec/EmployeeGlobalInformation/Builders/PerGlobalInfoBRAEntityBuilder");
...
exports.entityBuilder = function() {
	return new PerGlobalInfoBRAEntityBuilder();
};

exports.getClient = function(configurations) {
	return new PerGlobalInfoBRAClient(configurations);
};

exports.getClientAsync = function(configurations) {
	return new PerGlobalInfoBRAClientAsync(configurations);
};

function PerGlobalInfoBRAClient (configurations) {

	var API_PATH = "/odata/v2/PerGlobalInfoBRA";
...
function PerGlobalInfoBRAClientAsync (configurations) {
