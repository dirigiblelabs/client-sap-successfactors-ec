...
var PerGlobalInfoCANEntityBuilder = require("sap-successfactors-ec/EmployeeGlobalInformation/Builders/PerGlobalInfoCANEntityBuilder");
...
exports.entityBuilder = function() {
	return new PerGlobalInfoCANEntityBuilder();
};

exports.getClient = function(configurations) {
	return new PerGlobalInfoCANClient(configurations);
};

exports.getClientAsync = function(configurations) {
	return new PerGlobalInfoCANClientAsync(configurations);
};

function PerGlobalInfoCANClient (configurations) {

	var API_PATH = "/odata/v2/PerGlobalInfoCAN";
...
function PerGlobalInfoCANClientAsync (configurations) {
