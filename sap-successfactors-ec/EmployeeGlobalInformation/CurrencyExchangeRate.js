...
var CurrencyExchangeRateEntityBuilder = require("sap-successfactors-ec/EmployeeGlobalInformation/Builders/CurrencyExchangeRateEntityBuilder");

exports.CREATED_BY = "createdBy";
exports.CREATED_DATE_TIME = "createdDateTime";
exports.CURRENCY_EXCHANGE_RATE_TYPE = "currencyExchangeRateType";
exports.EFFECTIVE_END_DATE = "effectiveEndDate";
exports.EFFECTIVE_START_DATE = "effectiveStartDate";
exports.EFFECTIVE_STATUS = "effectiveStatus";
exports.EXCHANGE_RATE = "exchangeRate";
...
exports.SOURCE_CURRENCY = "sourceCurrency";
exports.TARGET_CURRENCY = "targetCurrency";
...
exports.entityBuilder = function() {
	return new CurrencyExchangeRateEntityBuilder();
};

exports.getClient = function(configurations) {
	return new CurrencyExchangeRateClient(configurations);
};

exports.getClientAsync = function(configurations) {
	return new CurrencyExchangeRateClientAsync(configurations);
};

function CurrencyExchangeRateClient (configurations) {

	var API_PATH = "/odata/v2/CurrencyExchangeRate";
...
function CurrencyExchangeRateClientAsync (configurations) {
