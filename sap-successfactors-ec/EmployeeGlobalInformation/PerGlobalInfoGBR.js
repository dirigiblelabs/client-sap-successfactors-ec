...
var PerGlobalInfoGBREntityBuilder = require("sap-successfactors-ec/EmployeeGlobalInformation/Builders/PerGlobalInfoGBREntityBuilder");
...
exports.entityBuilder = function() {
	return new PerGlobalInfoGBREntityBuilder();
};

exports.getClient = function(configurations) {
	return new PerGlobalInfoGBRClient(configurations);
};

exports.getClientAsync = function(configurations) {
	return new PerGlobalInfoGBRClientAsync(configurations);
};

function PerGlobalInfoGBRClient (configurations) {

	var API_PATH = "/odata/v2/PerGlobalInfoGBR";
...
function PerGlobalInfoGBRClientAsync (configurations) {
