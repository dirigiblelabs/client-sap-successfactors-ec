var method = NameFormatGOEntityBuilder.prototype;

function NameFormatGOEntityBuilder() {
...
method.sample = function(sample) {
	this.sample = sample;
	return this;
};

method.nameElements = function(nameElements) {
...
module.exports = NameFormatGOEntityBuilder;
