var method = AutoDelegateConfigEntityBuilder.prototype;

function AutoDelegateConfigEntityBuilder() {
...
method.delegator = function(delegator) {
...
method.autoDelegateDetails = function(autoDelegateDetails) {
	this.autoDelegateDetails = autoDelegateDetails;
	return this;
};
...
method.build = function() {
	return {
		...
		autoDelegateDetails: this.autoDelegateDetails,
		wfRequestNav: this.wfRequestNav
	};
};

module.exports = AutoDelegateConfigEntityBuilder;
