var method = ExternalTimeRecordEntityBuilder.prototype;

function ExternalTimeRecordEntityBuilder() {
...
method.deleteExternalTime = function(deleteExternalTime) {
	this.deleteExternalTime = deleteExternalTime;
	return this;
};
...
method.externalTimeSegments = function(externalTimeSegments) {
	this.externalTimeSegments = externalTimeSegments;
	return this;
};
...
method.build = function() {
	return {
		...
		date: this.date,
		deleteExternalTime: this.deleteExternalTime,
		...
		status: this.status,
		userId: this.userId,
		externalTimeSegments: this.externalTimeSegments
	};
};

module.exports = ExternalTimeRecordEntityBuilder;
