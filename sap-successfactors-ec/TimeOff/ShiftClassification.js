...
var ShiftClassificationEntityBuilder = require("sap-successfactors-ec/TimeOff/Builders/ShiftClassificationEntityBuilder");
...
exports.entityBuilder = function() {
	return new ShiftClassificationEntityBuilder();
};

exports.getClient = function(configurations) {
	return new ShiftClassificationClient(configurations);
};

exports.getClientAsync = function(configurations) {
	return new ShiftClassificationClientAsync(configurations);
};

function ShiftClassificationClient (configurations) {

	var API_PATH = "/odata/v2/ShiftClassification";
...
function ShiftClassificationClientAsync (configurations) {
