var method = TimeAccountPostingRuleEntityBuilder.prototype;

function TimeAccountPostingRuleEntityBuilder() {

}

method.TimeType_externalCode = function(TimeType_externalCode) {
	this.TimeType_externalCode = TimeType_externalCode;
	return this;
};
...
method.timeAccountTypeNav = function(timeAccountTypeNav) {
	this.timeAccountTypeNav = timeAccountTypeNav;
	return this;
};

method.build = function() {
	return {
		TimeType_externalCode: this.TimeType_externalCode,
		...
		timeAccountTypeNav: this.timeAccountTypeNav
	};
};

module.exports = TimeAccountPostingRuleEntityBuilder;
