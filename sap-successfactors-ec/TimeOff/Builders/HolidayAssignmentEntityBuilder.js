var method = HolidayAssignmentEntityBuilder.prototype;

function HolidayAssignmentEntityBuilder() {

}

method.HolidayCalendar_externalCode = function(HolidayCalendar_externalCode) {
	this.HolidayCalendar_externalCode = HolidayCalendar_externalCode;
	return this;
};
...
method.holiday = function(holiday) {
	this.holiday = holiday;
	return this;
};

method.holidayClass = function(holidayClass) {
...
method.holidayNav = function(holidayNav) {
	this.holidayNav = holidayNav;
	return this;
};

method.build = function() {
	return {
		HolidayCalendar_externalCode: this.HolidayCalendar_externalCode,
		createdBy: this.createdBy,
		createdDate: this.createdDate,
		createdDateTime: this.createdDateTime,
		date: this.date,
		holiday: this.holiday,
		holidayClass: this.holidayClass,
		...
		holidayNav: this.holidayNav
	};
};

module.exports = HolidayAssignmentEntityBuilder;
