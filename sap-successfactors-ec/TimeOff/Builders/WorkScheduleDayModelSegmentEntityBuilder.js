var method = WorkScheduleDayModelSegmentEntityBuilder.prototype;

function WorkScheduleDayModelSegmentEntityBuilder() {

}

method.WorkScheduleDayModel_externalCode = function(WorkScheduleDayModel_externalCode) {
	this.WorkScheduleDayModel_externalCode = WorkScheduleDayModel_externalCode;
	return this;
};
...
method.build = function() {
	return {
		WorkScheduleDayModel_externalCode: this.WorkScheduleDayModel_externalCode,
...
module.exports = WorkScheduleDayModelSegmentEntityBuilder;
