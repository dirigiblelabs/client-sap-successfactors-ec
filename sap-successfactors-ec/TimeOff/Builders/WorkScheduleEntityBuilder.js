var method = WorkScheduleEntityBuilder.prototype;

function WorkScheduleEntityBuilder() {

}

method.averageHoursPerDay = function(averageHoursPerDay) {
	this.averageHoursPerDay = averageHoursPerDay;
	return this;
};

method.averageHoursPerMonth = function(averageHoursPerMonth) {
	this.averageHoursPerMonth = averageHoursPerMonth;
	return this;
};

method.averageHoursPerWeek = function(averageHoursPerWeek) {
	this.averageHoursPerWeek = averageHoursPerWeek;
	return this;
};

method.averageHoursPerYear = function(averageHoursPerYear) {
	this.averageHoursPerYear = averageHoursPerYear;
	return this;
};

method.averageWorkingDaysPerWeek = function(averageWorkingDaysPerWeek) {
	this.averageWorkingDaysPerWeek = averageWorkingDaysPerWeek;
	return this;
};
...
method.individualWorkSchedule = function(individualWorkSchedule) {
	this.individualWorkSchedule = individualWorkSchedule;
	return this;
};
...
method.modelCategory = function(modelCategory) {
	this.modelCategory = modelCategory;
	return this;
};

method.periodModel = function(periodModel) {
	this.periodModel = periodModel;
	return this;
};

method.searchString = function(searchString) {
...
method.startingDate = function(startingDate) {
...
method.periodModelNav = function(periodModelNav) {
	this.periodModelNav = periodModelNav;
	return this;
};
...
method.workScheduleDayModels = function(workScheduleDayModels) {
	this.workScheduleDayModels = workScheduleDayModels;
	return this;
};

method.workScheduleDays = function(workScheduleDays) {
...
method.build = function() {
	return {
		averageHoursPerDay: this.averageHoursPerDay,
		averageHoursPerMonth: this.averageHoursPerMonth,
		averageHoursPerWeek: this.averageHoursPerWeek,
		averageHoursPerYear: this.averageHoursPerYear,
		averageWorkingDaysPerWeek: this.averageWorkingDaysPerWeek,
		...
		individualWorkSchedule: this.individualWorkSchedule,
		...
		userId: this.userId,
		periodModelNav: this.periodModelNav,
		shiftClassificationNav: this.shiftClassificationNav,
		workScheduleDayModels: this.workScheduleDayModels,
		workScheduleDays: this.workScheduleDays
	};
};

module.exports = WorkScheduleEntityBuilder;
