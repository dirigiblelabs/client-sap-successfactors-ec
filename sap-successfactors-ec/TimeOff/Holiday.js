...
var HolidayEntityBuilder = require("sap-successfactors-ec/TimeOff/Builders/HolidayEntityBuilder");

exports.COUNTRY = "country";
exports.CREATED_BY = "createdBy";
exports.CREATED_DATE = "createdDate";
exports.CREATED_DATE_TIME = "createdDateTime";
exports.HOLIDAY_CODE = "holidayCode";
...
exports.getClient = function(configurations) {
	return new HolidayClient(configurations);
};

exports.getClientAsync = function(configurations) {
	return new HolidayClientAsync(configurations);
};

function HolidayClient (configurations) {

	var API_PATH = "/odata/v2/Holiday";
...
function HolidayClientAsync (configurations) {
