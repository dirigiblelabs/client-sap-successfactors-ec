...
var PaymentMethodV3EntityBuilder = require("sap-successfactors-ec/PaymentInformation/Builders/PaymentMethodV3EntityBuilder");
...
exports.TO_PAYMENT_METHOD_ASSIGNMENT_V3 = "toPaymentMethodAssignmentV3";
...
exports.entityBuilder = function() {
	return new PaymentMethodV3EntityBuilder();
};

exports.getClient = function(configurations) {
	return new PaymentMethodV3Client(configurations);
};

exports.getClientAsync = function(configurations) {
	return new PaymentMethodV3ClientAsync(configurations);
};

function PaymentMethodV3Client (configurations) {

	var API_PATH = "/odata/v2/PaymentMethodV3";
...
function PaymentMethodV3ClientAsync (configurations) {
