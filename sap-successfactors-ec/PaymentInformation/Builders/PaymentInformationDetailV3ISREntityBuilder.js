var method = PaymentInformationDetailV3ISREntityBuilder.prototype;

function PaymentInformationDetailV3ISREntityBuilder() {
...
method.branchName = function(branchName) {
	this.branchName = branchName;
	return this;
};

method.branchNumberCode = function(branchNumberCode) {
	this.branchNumberCode = branchNumberCode;
	return this;
};
...
method.build = function() {
	return {
		...
		branchNumberCode: this.branchNumberCode,
...
module.exports = PaymentInformationDetailV3ISREntityBuilder;
