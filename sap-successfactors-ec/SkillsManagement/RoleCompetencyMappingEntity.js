...
var RoleCompetencyMappingEntityEntityBuilder = require("sap-successfactors-ec/SkillsManagement/Builders/RoleCompetencyMappingEntityEntityBuilder");
...
exports.entityBuilder = function() {
	return new RoleCompetencyMappingEntityEntityBuilder();
};

exports.getClient = function(configurations) {
	return new RoleCompetencyMappingEntityClient(configurations);
};

exports.getClientAsync = function(configurations) {
	return new RoleCompetencyMappingEntityClientAsync(configurations);
};

function RoleCompetencyMappingEntityClient (configurations) {

	var API_PATH = "/odata/v2/RoleCompetencyMappingEntity";
...
function RoleCompetencyMappingEntityClientAsync (configurations) {
