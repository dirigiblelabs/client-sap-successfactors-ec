...
var JobResponsibilityEntityEntityBuilder = require("sap-successfactors-ec/SkillsManagement/Builders/JobResponsibilityEntityEntityBuilder");
...
exports.DUTY_DE__D_E = "duty_de_DE";
exports.DUTY_DEFAULT_VALUE = "duty_defaultValue";
exports.DUTY_EN__G_B = "duty_en_GB";
exports.DUTY_EN__U_S = "duty_en_US";
exports.DUTY_ES__E_S = "duty_es_ES";
exports.DUTY_FR__F_R = "duty_fr_FR";
exports.DUTY_JA__J_P = "duty_ja_JP";
exports.DUTY_KO__K_R = "duty_ko_KR";
exports.DUTY_LOCALIZED = "duty_localized";
exports.DUTY_NL__N_L = "duty_nl_NL";
exports.DUTY_PT__B_R = "duty_pt_BR";
exports.DUTY_PT__P_T = "duty_pt_PT";
exports.DUTY_RU__R_U = "duty_ru_RU";
exports.DUTY_ZH__C_N = "duty_zh_CN";
exports.DUTY_ZH__T_W = "duty_zh_TW";
...
exports.entityBuilder = function() {
	return new JobResponsibilityEntityEntityBuilder();
};

exports.getClient = function(configurations) {
	return new JobResponsibilityEntityClient(configurations);
};

exports.getClientAsync = function(configurations) {
	return new JobResponsibilityEntityClientAsync(configurations);
};

function JobResponsibilityEntityClient (configurations) {

	var API_PATH = "/odata/v2/JobResponsibilityEntity";
...
function JobResponsibilityEntityClientAsync (configurations) {
