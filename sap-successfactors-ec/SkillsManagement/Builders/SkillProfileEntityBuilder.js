var method = SkillProfileEntityBuilder.prototype;

function SkillProfileEntityBuilder() {
...
method.ratedSkills = function(ratedSkills) {
	this.ratedSkills = ratedSkills;
	return this;
};

method.selfReportSkills = function(selfReportSkills) {
	this.selfReportSkills = selfReportSkills;
	return this;
};
...
method.build = function() {
	return {
		...
		ratedSkills: this.ratedSkills,
		selfReportSkills: this.selfReportSkills
	};
};

module.exports = SkillProfileEntityBuilder;
