...
var RoleSkillMappingEntityEntityBuilder = require("sap-successfactors-ec/SkillsManagement/Builders/RoleSkillMappingEntityEntityBuilder");
...
exports.entityBuilder = function() {
	return new RoleSkillMappingEntityEntityBuilder();
};

exports.getClient = function(configurations) {
	return new RoleSkillMappingEntityClient(configurations);
};

exports.getClientAsync = function(configurations) {
	return new RoleSkillMappingEntityClientAsync(configurations);
};

function RoleSkillMappingEntityClient (configurations) {

	var API_PATH = "/odata/v2/RoleSkillMappingEntity";
...
function RoleSkillMappingEntityClientAsync (configurations) {
