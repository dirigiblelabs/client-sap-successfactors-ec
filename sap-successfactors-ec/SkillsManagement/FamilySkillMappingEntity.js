...
var FamilySkillMappingEntityEntityBuilder = require("sap-successfactors-ec/SkillsManagement/Builders/FamilySkillMappingEntityEntityBuilder");
...
exports.entityBuilder = function() {
	return new FamilySkillMappingEntityEntityBuilder();
};

exports.getClient = function(configurations) {
	return new FamilySkillMappingEntityClient(configurations);
};

exports.getClientAsync = function(configurations) {
	return new FamilySkillMappingEntityClientAsync(configurations);
};

function FamilySkillMappingEntityClient (configurations) {

	var API_PATH = "/odata/v2/FamilySkillMappingEntity";
...
function FamilySkillMappingEntityClientAsync (configurations) {
