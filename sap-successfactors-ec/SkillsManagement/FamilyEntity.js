...
var FamilyEntityEntityBuilder = require("sap-successfactors-ec/SkillsManagement/Builders/FamilyEntityEntityBuilder");
...
exports.entityBuilder = function() {
	return new FamilyEntityEntityBuilder();
};

exports.getClient = function(configurations) {
	return new FamilyEntityClient(configurations);
};

exports.getClientAsync = function(configurations) {
	return new FamilyEntityClientAsync(configurations);
};

function FamilyEntityClient (configurations) {

	var API_PATH = "/odata/v2/FamilyEntity";
...
function FamilyEntityClientAsync (configurations) {
