var method = RightToReturnEntityBuilder.prototype;

function RightToReturnEntityBuilder() {

}

method.Position_code = function(Position_code) {
	this.Position_code = Position_code;
	return this;
};

method.Position_effectiveStartDate = function(Position_effectiveStartDate) {
	this.Position_effectiveStartDate = Position_effectiveStartDate;
	return this;
};
...
method.gaEndJobInfoId = function(gaEndJobInfoId) {
	this.gaEndJobInfoId = gaEndJobInfoId;
	return this;
};

method.gaEventReason = function(gaEventReason) {
	this.gaEventReason = gaEventReason;
	return this;
};

method.gaStartJobInfoId = function(gaStartJobInfoId) {
	this.gaStartJobInfoId = gaStartJobInfoId;
	return this;
};
...
method.loaTimeType = function(loaTimeType) {
	this.loaTimeType = loaTimeType;
	return this;
};
...
method.build = function() {
	return {
		...
		Position_effectiveStartDate: this.Position_effectiveStartDate,
		code: this.code,
		createdBy: this.createdBy,
		createdDateTime: this.createdDateTime,
		gaEndJobInfoId: this.gaEndJobInfoId,
		gaEventReason: this.gaEventReason,
		gaStartJobInfoId: this.gaStartJobInfoId,
		lastModifiedBy: this.lastModifiedBy,
		lastModifiedDateTime: this.lastModifiedDateTime,
		loaTimeType: this.loaTimeType,
...
module.exports = RightToReturnEntityBuilder;
