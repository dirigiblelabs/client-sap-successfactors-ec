var method = PositionMatrixRelationshipEntityBuilder.prototype;

function PositionMatrixRelationshipEntityBuilder() {
...
method.matrixRelationshipType = function(matrixRelationshipType) {
...
method.relatedPosition = function(relatedPosition) {
	this.relatedPosition = relatedPosition;
	return this;
};

method.relatedPositionNav = function(relatedPositionNav) {
	this.relatedPositionNav = relatedPositionNav;
	return this;
};
...
method.build = function() {
	return {
		...
		matrixRelationshipType: this.matrixRelationshipType,
		...
		relatedPositionNav: this.relatedPositionNav
	};
};

module.exports = PositionMatrixRelationshipEntityBuilder;
